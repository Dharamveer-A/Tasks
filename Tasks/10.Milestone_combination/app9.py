...
if jd_file and resume_file:
    ...
    with col1:
        if resume_file:
            ...
            st.text_area("Resume Preview", resume_text, height=200, key="resume_preview")

    with col2:
        if jd_file:
            jd_text = extract_text(jd_file)
            st.text_area("Job Description Preview", jd_text, height=200, key="jd_preview")
    ...
    with col2:
        ...
        st.download_button("⬇DOCX Report", doc_file, "skill_gap_analysis_report.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", help="Download formatted Word report with complete analysis")
    ...
    with col3:
        ...
        try:
            ...
            st.download_button(label="⬇PDF Report", data=pdf_bytes, file_name="skill_gap_analysis_report.pdf", mime="application/pdf", help="Download formatted PDF report with visualizations")
        except Exception as e:
