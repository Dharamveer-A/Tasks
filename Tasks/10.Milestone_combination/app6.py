...
st.markdown(
    ...
    ">
        <h1 style="color:white; text-align:center; margin:0;">
            SkillGap AI – Resume & Job Post Analyzer
        </h1>
    </div>
    """,
...
if jd_file and resume_file:
    ...
    def plot_category_match_heatmap(resume_skills, jd_skills):
        ...
        for category in categories:
            jd_cat_skills = set(jd_categorized[category])
        ...
        fig.update_layout(
            title="Category-wise Skill Match Heatmap",
            barmode='stack',
            height=500,
